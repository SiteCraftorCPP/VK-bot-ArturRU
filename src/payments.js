...
function getPaymentConfig() {
  return {
    ...
    subscriptionAmountRub: Number(process.env.SUBSCRIPTION_AMOUNT || 1),
    boostAmountRub: Number(process.env.BOOST_AMOUNT || 1),
    subscriptionDays: Number(process.env.SUBSCRIPTION_DAYS || 30),
    boostDays: Number(process.env.BOOST_DAYS || 7),
    subscriptionDescription: process.env.PAYMENT_SUBSCRIPTION_DESCRIPTION || 'Доступ к боту 30 дней',
    boostDescription: process.env.PAYMENT_BOOST_DESCRIPTION || 'Поднятие анкеты в топ',
